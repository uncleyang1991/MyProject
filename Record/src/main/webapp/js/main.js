$(function(){
    ...
    $("#addEpisodeModal_button_submit").on('click',function(){
        ...
        obj.watchState = $('#addEpisodeModal_input_watchState').val().trim();
    ...
    $('#updateEpisodeModal_button_submit').on('click',function(){
        ...
        obj.watchState = $('#updateEpisodeModal_input_watchState').val().trim();
...
function loadTableData(isSearch){
...
function updateEpisodeButtonInList(me){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#updateEpisodeModal_input_watchState').val(episode.watchState);
